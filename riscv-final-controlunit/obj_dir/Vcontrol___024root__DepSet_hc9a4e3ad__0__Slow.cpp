...
VL_ATTR_COLD void Vcontrol___024root___eval_static(Vcontrol___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcontrol__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcontrol___024root___eval_static\n"); );
}
...
VL_ATTR_COLD void Vcontrol___024root___eval_final(Vcontrol___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcontrol__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcontrol___024root___eval_final\n"); );
}

VL_ATTR_COLD void Vcontrol___024root___eval_triggers__stl(Vcontrol___024root* vlSelf);
#ifdef VL_DEBUG
VL_ATTR_COLD void Vcontrol___024root___dump_triggers__stl(Vcontrol___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD void Vcontrol___024root___eval_stl(Vcontrol___024root* vlSelf);
...
VL_ATTR_COLD void Vcontrol___024root___eval_settle(Vcontrol___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vcontrol___024root___eval_triggers__stl(vlSelf);
        if (vlSelf->__VstlTriggered.any()) {
            __VstlContinue = 1U;
            if ((0x64U < vlSelf->__VstlIterCount)) {
#ifdef VL_DEBUG
                Vcontrol___024root___dump_triggers__stl(vlSelf);
#endif
                VL_FATAL_MT("control.sv", 1, "", "Settle region did not converge.");
            }
            vlSelf->__VstlIterCount = ((IData)(1U) 
                                       + vlSelf->__VstlIterCount);
            Vcontrol___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vcontrol___024root___dump_triggers__stl(Vcontrol___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcontrol__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcontrol___024root___dump_triggers__stl\n"); );
    // Body
...
void Vcontrol___024root___ico_sequent__TOP__0(Vcontrol___024root* vlSelf);

VL_ATTR_COLD void Vcontrol___024root___eval_stl(Vcontrol___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcontrol__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcontrol___024root___eval_stl\n"); );
    // Body
    if (vlSelf->__VstlTriggered.at(0U)) {
...
VL_ATTR_COLD void Vcontrol___024root___dump_triggers__ico(Vcontrol___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcontrol__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcontrol___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vcontrol___024root___dump_triggers__act(Vcontrol___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcontrol__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcontrol___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vcontrol___024root___dump_triggers__nba(Vcontrol___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcontrol__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcontrol___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vcontrol___024root___ctor_var_reset(Vcontrol___024root* vlSelf) {
    ...
    vlSelf->control__DOT__Branch = VL_RAND_RESET_I(1);
    vlSelf->control__DOT__ALUOp = VL_RAND_RESET_I(2);
