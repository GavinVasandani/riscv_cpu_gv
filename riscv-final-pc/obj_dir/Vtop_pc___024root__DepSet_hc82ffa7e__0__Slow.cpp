...
#endif
                VL_FATAL_MT("top_pc.sv", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop_pc___024root___stl_sequent__TOP__0(Vtop_pc___024root* vlSelf) {
    ...
    vlSelf->top_pc__DOT__pcReg__DOT__next_PC = ((2U 
                                                 & (IData)(vlSelf->J))
                                                 ? vlSelf->jalr_PC
                                                 : 
                                                ((1U 
...
VL_ATTR_COLD void Vtop_pc___024root___ctor_var_reset(Vtop_pc___024root* vlSelf) {
    ...
    vlSelf->jalr_PC = VL_RAND_RESET_I(32);
    vlSelf->PCsrc = VL_RAND_RESET_I(1);
    vlSelf->J = VL_RAND_RESET_I(2);
