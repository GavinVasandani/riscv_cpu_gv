...
VL_ATTR_COLD void Vtop_pc___024root__trace_init_sub__TOP__0(Vtop_pc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+4,"rst", false,-1);
    tracep->declBus(c+7,"PC", false,-1, 31,0);
    tracep->declBus(c+6,"pc_alu", false,-1, 31,0);
    tracep->declBus(c+8,"inc_PC", false,-1, 31,0);
    tracep->declBus(c+9,"alt_PC", false,-1, 31,0);
    tracep->declBus(c+10,"next_PC", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop_pc___024root__trace_full_sub_0(Vtop_pc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+7,(vlSelf->top_pc__DOT__PC),32);
    bufp->fullIData(oldp+8,(((IData)(4U) + vlSelf->top_pc__DOT__PC)),32);
    bufp->fullIData(oldp+9,((vlSelf->top_pc__DOT__PC 
                             + vlSelf->ImmOp)),32);
    bufp->fullIData(oldp+10,(((IData)(vlSelf->PCsrc)
                               ? (vlSelf->top_pc__DOT__PC 
                                  + vlSelf->ImmOp) : 
                              ((IData)(4U) + vlSelf->top_pc__DOT__PC))),32);
